...
def train_and_track(model, optimizers, trainloader, evalloader, testloader, device, epochs, is_cifar, run_id=""):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % 10 == 0 or epoch == epochs:
            print(f"[{run_id}] Epoch {epoch:03d}/{epochs} | Train (S0/S1): {tr_s0:5.1f}/{tr_s1:5.1f} | Test (S0/S1): {te_s0:5.1f}/{te_s1:5.1f}")
